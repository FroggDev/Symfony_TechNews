...
-- Export de données de la table technewssf.author : ~0 rows (environ)
/*!40000 ALTER TABLE `author` DISABLE KEYS */;
INSERT INTO `author` (`id`, `last_name`, `first_name`, `email`, `password`, `date_inscription`, `roles`, `last_connexion`) VALUES
...
-- Export de données de la table technews-rouen.category : ~4 rows (environ)
...
INSERT INTO `article` (`id`, `author_id`, `category_id`, `title`, `content`, `featured_image`, `special`, `spotlight`, `date_creation`) VALUES
